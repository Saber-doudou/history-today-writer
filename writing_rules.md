...
### 5I.3 数据口径统一检查（P0强制）
全篇数据口径必须一致。选定"总人数"或"乘客数"后，贯穿到底。
...
8. ✗ **排他性措辞未验证**: "第一/唯一/最/首次"等排他性或价值判断修饰词，写入前必须双源验证
9. ✗ **人物弧光等同人物百科**: 人物后半生必须服务于主旨
10. ✗ **元评价词**: "触目惊心""令人震惊""令人发指"等词，替换为具体意象
11. ✗ **面积/数字对比未验证**: "相当于X个Y"必须数学验证
12. ✗ **情节细节凭空添加**: 关键动作细节必须有史料来源
13. ✗ **阴谋论空洞化**: 提出疑点时必须附带至少一个具体异常
14. ✗ **备胎叙事缺"真命天子"**: "应急方案逆袭"类叙事不交代被替代的原计划 → Rule 45
15. ✗ **科技史只有商业故事**: 科技史题材只写竞争/发布/成功，不交代核心技术决策 → Rule 46
16. ✗ **时间线阶段混淆**: "X天造出Y"式表述不区分设计与实现阶段 → Rule 47
...
### 叙事时间链检查
每次出现"第一次""首次"等时序排他性措辞前，必须验证先例。违反=P0。
