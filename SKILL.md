...
- 写完后必须运行 `scripts/sync_check.py` 核验（规则数 182=127+55、版本号、文件路径、hot 规则正文完整性）
...
| 写作核心 | `writing_core.md` | 叙事结构+6维工具包+78条hot规则（core 56 + 题材专项 22）+基础/hot禁止模式+温控表（v9.7.8瘦身：26条cold Forbidden正文与cold状态表已迁 archive） |
