...
| 2026-05-25 | IMA版有两处P0级事实错误：①将昆斯伯里侯爵的辩护律师卡森错标为"检察官" ②法官"最令人作呕"引语仅单源未验证 | **人物身份必须双源**：律师/检察官/法官等法庭角色不可混淆——这类错误在社交媒体会被一眼识破。**引语强度与验证强度成反比**：越是"有力"的法官引语，越可能是后世演绎，必须更严格验证 |
| 2026-05-25 | IMA版人物弧光更完整（《自深深处》+后世纪念），为v3补充了狱中创作和百年后纪念 | **人物弧光的终点不在死，在死后**：如果事件有充分的后世纪念（雕像/立碑/地名/文艺作品），应收入作为弧光的最终环——读者需要知道"历史最终如何评判这个人" |
| 2026-05-26 | 四AI（DS/豆包/IMA/千问）同题对比敦煌藏经洞：一致指出4处P0史实错误（时间跨度14世纪→11世纪、酬金40马蹄银→200两、面积平方米→立方米、结尾缺正面收束） | **时间跨度校验（P0级）**：涉及"X世纪到Y世纪"的跨度声明必须与事件封闭/结束时间严格吻合。**考古背景三步法**：文化史/考古类事件必须回答"原是什么→为什么封存→多久后发现"。**结尾给光规则（P1级）**：文化史/流散类事件结尾不能停在叹息，必须至少给一句正面收束（后人接续奋斗/数字化重聚等）。**批判矛头上移**：悲剧归因上移至系统而非个体（禁用"不识字""无知"等归因）。**叙事均衡检查**：多人/多阶段事件须确保各阶段比例均衡，不可第一阶段半篇后续一笔带过。**数据分歧处理**：各AI版本间存在分歧的数据（酬金/件数/面积），必须找多数来源共识写入 |
