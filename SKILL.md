...
| 13 | **80/20 Fact-Fiction ratio** | 🆕 Core facts (person, event, outcome, date) must be 100% accurate. Artistic liberty restricted to: psychological interior, dialogue completion, sensory environment detail. **Never fabricate core historical facts.** **比喻必须经得起事实推敲**：涉及人物动机的比喻需验证是否符合史实——修辞服务于事实，不是事实服务于修辞。 | ✅ 允许：揣摩林白在驾驶舱的内心活动 / ❌ 禁止：虚构林白中途降落加油 / ❌ 禁止："恐惧是最好的防弹衣"（实际源于傲慢） |
...
□ Rule 20 — 元评价词检查：是否用了"触目惊心""令人震惊"等词？→ 替换为具体意象
□ Rule 21 — 面积/数字类比是否数学验证？（"X个Y"必须算清楚）
□ Rule 22 — 节奏词检查：是否有"正""也""却""整整""据""此时的""还被""只是"等小词增强张力？
□ Rule 23 — 谈判/条约叙事是否有硬史料原话？（禁止只用形容词描述交锋）
□ Rule 24 — 侵略/扩张类事件是否交代了侵略者前期布局？
□ Rule 25 — 结尾批判矛头是否指向系统/结构而非个人？
□ Rule 26 — 情节细节（摔杯、当众羞辱、推搡等）是否有史料来源？→ 无法验证的具体动作改用模糊但准确的表述
□ Rule 27 — 阴谋论/疑点是否附带具体异常？→ 不能只抛"为什么？"，需给出至少一个具体线索（伤口位置、不在场证明、安保漏洞等）
□ Rule 28 — 涉及民间传说/谶语/预言时，是否用"相传""据传"标注其传说性质？→ 区分史实与传说
□ Rule 29 — 人物关系链是否交代清楚？→ "老国王的弟弟贾南德拉，也就是迪彭德拉的叔叔"优于"叔叔贾南德拉"
□ Rule 30 — 过渡句是否自然？→ "导致这场悲剧发生的，是"优于"撕裂王室的，是"（不刻意文学化）
```
...
10. ✗ **元评价词** 🆕v5.4: "触目惊心""令人震惊""令人发指"等直接告诉读者该怎么感受的词，违反Show Don't Tell。用具体意象让读者自己感受——"白纸黑字，每一行都是国土"优于"条约内容触目惊心"
11. ✗ **面积/数字对比未验证** 🆕v5.4: 任何面积、数量的类比（"相当于X个Y"）必须数学验证。"两个法国"≈108万≠60万，"四个河南省"=60万——随手写的类比可能精确度差一倍
12. ✗ **情节细节凭空添加** 🆕v5.7: 关键动作细节（摔碎酒杯、当众羞辱、推搡等）必须有史料来源。无法验证的具体动作→改用更模糊但准确的表述（如"醉酒失态"而非"摔碎酒杯"）。Rule 13不仅管人名/数字，也管关键动作
13. ✗ **阴谋论空洞化** 🆕v5.7: 提出疑点时必须附带至少一个具体异常（伤口位置、不在场证明、安保漏洞等），不能只抛"为什么？"却不给线索
...
- □ 是否有未解释的专业术语或背景知识？
- □ 读者能在人物身上看到自己的影子吗？
- □ 涉及儿童/平民伤亡的事件，是否检查了后续文化影响？（纪念日/节日/法律变更/国际公约）
...
## 5G. v5.3 专项自检 (2026-05-26 🆕)

> 来源：敦煌藏经洞四AI同题诊断（DS/豆包/IMA/千问四版对比）。

### 5G.1 时间跨度校验（P0强制）

**规则**：涉及"X世纪到Y世纪"的跨度声明，必须与事件封闭/结束时间严格吻合。

**典型错误**：藏经洞11世纪封闭，写"4至14世纪"——14世纪已超出封闭年限。

**自检**：写作中每次出现时间跨度时，必须验证：
- □ Y世纪是否超出事件的封闭/结束/消亡时间？
- □ 跨度的两端各依据什么史料？

### 5G.2 考古/文化史背景三步法

**规则**：任何考古/文化史类事件，必须用至少一句话回答三个问题：
1. **是什么**：这个遗迹/洞窟/文物原本是什么？（如"原是唐代高僧洪辩的影窟"）
2. **为什么封存/存在**：为何在此？何种原因导致封闭/埋藏？（如"11世纪因战乱逼近，僧人秘藏于此"）
3. **多久后发现**：封闭了多少年才被发现？（如"幽闭近八百年"）

**自检**：读者看到"藏经洞"三字时，会本能地问"这东西为什么在那里？"——不回答此问题等同于叙事缺失。

### 5G.3 结尾给光规则（P1强制，文化史/流散类）

**规则**：文化史、文物流失、文明劫难等"失去"类事件，结尾不能停在叹息。必须至少给一句正面收束。

**正面收束选项**：
- 后人接续奋斗（如常书鸿、樊锦诗）
- 数字化/科技修复（如"数字敦煌""云端重聚"）
- 当代格局变化（如"敦煌学也在中国"）
- 国际协作（如国际敦煌项目）

**自检**：如果结尾最后一个句号之前没有任何正面元素，扣为P1——结尾不给光。
...
- ✅ 官僚系统冷漠（"无人理会""就地封存"）
- ✅ 国力衰弱（"那个时代的中国还没有能力守护"）
- ✅ 制度性缺失（"没有保护，没有运费，什么都没有"）

**自检**：文物流失/文明劫难叙事中，是否出现了将悲剧归因于个体"不识字""无知"的表述？→ 有则P1

### 5G.5 叙事均衡检查

**规则**：多人/多阶段事件，各阶段叙事比例大体均衡。

**典型失衡**：斯坦因占半篇，伯希和2句，日/俄/美各1句，国内监守一句不提。

**自检**：事件涉及N个阶段/人物时，每个的篇幅是否大致成比例？

### 5G.6 数据分歧处理

**规则**：各AI版本间存在分歧的数据（酬金、件数、面积等），不可取单版本数据写入。必须找到多数来源共识。

**典型分歧**：斯坦因酬金——DS说200两、千问说200两、IMA说"少量银两"、豆包说"200多两"、原版说"40块马蹄银500卢比"。多数共识：约200两白银。

**自检**：
- □ 核心数据（酬金/件数/面积）是否各AI版本一致？
- □ 若不一致，是否选取了多数来源共识？
- □ 歧义数据是否标注了"约"？
...
> 来源：Master对瑷珲条约v2版的16处微调。核心发现：**大框架能搭好，小词的节奏感是最大短板**。"正""也""却""整整""据""此时的""还被""只是"这些小词就像螺丝钉，把叙事拧得更紧。

### 16个节奏词技法

| # | 技法 | 示例 | 效果 |
|---|------|------|------|
| 1 | **关键人物首次出场用破折号** | "清朝黑龙江将军——奕山" | 人名出场有停顿感，读者注意力被引导 |
| 2 | **对称结构增强韵律** | 两个人物分别用破折号和逗号隔开 | 节奏对仗，阅读舒适 |
| 3 | **"正"字增加紧迫感** | "炮口正对准江岸" | 强调正在进行的威胁 |
| 4 | **用朝代正式名称** | "大清帝国"比"清帝国" | 更有历史质感 |
| 5 | **递进连词制造压力叠加** | "天津也危在旦夕" | "也"字层层递进 |
| 6 | **四字成语前用破折号断句** | "他们要——趁火打劫" | 短促有力，节奏干净 |
| 7 | **数量词前加"整整"** | "谈判持续整整六天" | 增强分量感 |
| 8 | **副词"地"不能省** | "强硬地要求" | 语法规范，书面感 |
| 9 | **转折连词制造叙事张力** | "却不耐烦地打断他" | 争辩→被驳回的戏剧性 |
| 10 | **长句拆短句** | 破折号拆成句号+"但" | 阅读节奏更好 |
| 11 | **传闻加"据"字标注来源** | "据后来俄兵酒后吐露" | 信息来源严谨 |
| 12 | **时间锚点防跳跃** | "但此时的奕山" | 与前文呼应，不跳 |
...
**规则**：灾难/事故类事件中，必须交代导致灾难加速的"连锁反应环节"。仅写"撞击→沉没"是不够的——读者需要知道"为什么这么快"。

**典型遗漏**：皇后号初稿只写"撞船→14分钟沉没"，未交代Storstad倒车退出导致裂口彻底暴露这一关键加速环节。

**自检**：
- □ 灾难从发生到结果之间，是否有≥2个"加速因素"被交代？
- □ 读者读完能回答"为什么这么快/这么惨"吗？

### 5I.2 技术设计缺陷检查（P1强制，机械/技术类）

**规则**：当灾难的根本原因涉及机械设计或技术标准时，必须明确点出"设计死穴"。

**典型手法**：手动 vs 自动、机械 vs 电子、旧标准 vs 新标准——这类技术对比往往是"为什么泰坦尼克有2小时而皇后号只有14分钟"的根本原因。

**自检**：
- □ 灾难是否涉及设备/设计/标准的缺陷？如果是，是否明确点出？
- □ 读者能理解"这个缺陷为什么致命"吗？

### 5I.3 数据口径统一检查（P0强制）

**规则**：全篇数据口径必须一致。选定"总人数"或"乘客数"后，贯穿到底，不可中途切换。

**典型错误**：初稿前半段用"1057名乘客"，后半段用"1012人遇难"（总死亡），造成"只有217人获救"与"465人幸存"的逻辑矛盾。

**自检**：
- □ 全篇的死亡/幸存数据是否口径统一？
- □ 如果同时出现乘客数和总数，是否明确标注"其中乘客XX人"？

### 5I.4 不可考证数字替换规则

**规则**：当一个具体数字（如"每秒六万加仑"）无法被普通读者验证或感知时，替换为可感知的描写（如"河水以惊人的速度涌入"）。精确但不可感知的数字反而削弱可信度。

**自检**：
- □ 文中是否有"看起来很精确但读者无法感知"的数字？
- □ 是否可以用更安全的描述替代？

### 5I.5 特殊群体展开规则（P2强制）

**规则**：当事件涉及特殊群体（救世军乐队、移民、儿童等）时，不可仅罗列数字。必须交代至少一个"身份/目的/记忆点"。

**典型问题**：初稿"167名救世军乐队成员，几乎全部沉入河底"——信息碎片，无情感着力点。

**展开手法**：
- 身份：他们是谁？（年轻乐手）
- 目的：他们要去哪？（赶往伦敦参加大会）
- 记忆点：有什么具象细节？（追悼仪式上空椅子摆着乐器）

**自检**：
- □ 文中是否出现了仅罗列数字的特殊群体？
- □ 该群体是否有至少一个"身份/目的/记忆点"？
...
| **P1** | **元评价词** 🆕v5.4 | 使用"触目惊心""令人震惊"等直接告诉读者该怎么感受的词，违反Show Don't Tell。应用具体意象替代 |
| **P2** | **面积/数字类比未验证** 🆕v5.4 | 面积、数量的类比（"相当于X个Y"）未做数学验证，可能导致精确度差一倍 |
| **P1** | **灾难因果链断裂** 🆕v5.6 | 灾难/事故类事件仅写"发生→结果"，未交代关键的连锁反应加速环节（如倒车暴露裂口、手动水密门关不上） |
| **P1** | **技术死穴未点出** 🆕v5.6 | 灾难涉及设备/设计缺陷时未明确说明，导致读者不理解"为什么这么快/这么惨" |
| **P0** | **数据口径矛盾** 🆕v5.6 | 全篇数据口径不统一（乘客数/总人数混用），导致死亡+幸存数据逻辑矛盾 |
| **P2** | **特殊群体仅罗列数字** 🆕v5.6 | 涉及特殊群体（乐队/移民/儿童等）时仅写人数，未展开身份/目的/记忆点 |
| **P1** | **核心意象重复** 🆕v6.0 | 核心意象（如"回程票"）在全文中出现两次，削弱首次出现的震撼力（Rule 37） |
| **P1** | **标题剧透** 🆕v6.0 | 标题直接揭示文章最大悬念/反转（Rule 38） |
| **P1** | **判断过于绝对** 🆕v6.0 | 对历史学界有争议的问题下定论，未留推测余地（Rule 39） |
| **P2** | **非核心人物缺"据传"** 🆕v6.0 | 非核心人物生平细节来源不够权威却写得过于确定（Rule 40） |
| **P1** | **激进行为缺制度背景** 🆕v6.0 | 涉及激进行为时未补充制度压迫背景（Rule 41） |
| **P0** | **四AI一致指出** 🆕v6.0 | 四个AI一致指出同一问题，自动升级为P0级（Rule 42） |
| **P0** | **援助/条约范围错误** 🆕v6.1 | 经济援助/条约题材中将不属于覆盖范围的对象错误纳入（Rule 43） |
| **P1** | **决策缺触发因素** 🆕v6.1 | 主角重大决策缺少直接触发事件交代，读者感到突兀（Rule 44） |
...
**自检**：写完教训后自问——"换个事件，这个规律还能用吗？"如果不能，再抽象一层。

### 9A.2 文件架构三层分离

| 层 | 文件 | 职责 | 类比 |
|----|------|------|------|
| 法典 | SKILL.md | 规则+结构+评分+Feedback摘要 | 法条 |
| 判例 | review/CASE_STUDIES.md | 详细案例分析+四AI对比+各版贡献 | 判例集 |
| 索引 | archive/daily/TOPICS.md | 选题去重+关键数据点+3行复盘摘要 | 档案索引 |

**更新规则**：
- SKILL.md：规则变更时更新（新增Rule/修改评分矩阵等）
- CASE_STUDIES.md：每次四AI对比后追加新案例
- TOPICS.md：每次执行后追加选题+数据点+3行摘要
...
|------|-------|------------|----------|
| 2026-05-09 | 王尔德 | "It's not X, it's Y" works for events but NOT for character evaluations | — |
| 2026-05-19 | 林白 | Single-source data is not trustworthy; don't manufacture tension through factual distortion | Rule 13 |
| 2026-05-22 | 朝美条约 | 条约叙事须含谈判冲突+妥协方案；人物弧光≠人物百科；排他性措辞须验证先例 | Rule 7, Rule 14 |
| 2026-05-24 | 司马迁 | 标题5法+现代参悟+人物心理三层递进+命运规律对照+读者视角+史料验证 | 5B-5F |
...
| 2026-05-28 | 节奏词 | 16个节奏词技法（破折号/正/也/整整/却/据/此时的/四字结构等） | 5H |
| 2026-05-29 | 皇后号 | 灾难因果链必须完整；技术死穴须点出；数据口径统一(P0)；特殊群体须展开 | 5I |
| 2026-06-01 | 尼泊尔 | 情节细节不可凭空添加(P0/Rule 26)；阴谋论须具体化(Rule 27)；最后通牒须写明；道德评价让位于事实 | Rule 26, 27 |
| 2026-06-02 | 王国维 | 成就罗列像维基百科(P1)；"世变"须具体事件支撑(P1)；文化符号须深层解读(P1)；自媒体过渡句(P2)；比喻须展开(P2)；结尾忌说教(P2) | 5J, Rule 31-35 |
| 2026-06-03 | 怀特太空行走 | 镜像细节是叙事金矿(舱门关不上vs打不开)；人物主观体验不可省略；地理方位须核实；时间跨度数字必须手工验算 | Rule 3, Rule 11, 5K |

---

## 9B. 四AI共性问题模式 (2026-06-02 🆕)

> 来源：王国维篇四AI（DS/IMA/千问/豆包）同题诊断。以下为四版一致指出的共性问题，已升级为强制规则。

### 5J. 成就罗列禁区（P1强制）

**规则**：人物类文章中，学术/职业/成就**禁止**以百科罗列方式呈现。每项成就必须服务于人物的内心冲突或主旨叙事。

**错误示例**：
> "《人间词话》提出'境界'说，至今是文艺理论的经典；《宋元戏曲考》开辟了中国戏曲研究的新领域；晚年考释甲骨文和敦煌文献，与罗振玉、郭沫若并称'甲骨四堂'。"

**正确方向**：将成就融入叙事——
> "他用从西方学来的方法，重新发现中国自己的学问——从词学到戏曲到甲骨文，每一步都是在为断裂的文脉接续。"

**自检**：
- □ 人物成就是否以罗列方式呈现？（像维基百科的条目？）
- □ 每项提到的成就是否服务于主旨？
- □ 成就是否与人物的内心冲突/抉择有关联？

### Rule 31. "世变"须具象化（P1强制）

**规则**：当文章主旨依赖于某个历史语境（如"世变""时局""乱世"）时，必须提供至少2个具体事件/情境使其可感知。抽象描述"世变"等于读者不知道"变"在哪里。
...
**规则**：涉及文化符号（辫子、服饰、仪式、建筑等）时，不能停留在表面描述（"顽固""坚持"），必须触及最深的文化含义层（如"道统""气节""文化自觉"）。
...
**规则**：禁止使用自媒体常见的引导式过渡句，如"要理解XX，得先看看……""说到XX，就不得不提……"。用内在逻辑和情绪推动段落转换。
...
**规则**：引入强力比喻后，不能点到为止。须在后文中至少回扣一次，或在结尾意象中呼应。
...
**规则**：禁止结尾使用"至今没有标准答案""留给后人思考""这个问题值得我们深思"等说教句式。用意象收束或碑文/引语自然收尾。
...
**规则**：涉及地理位置（轨道飞越区域、航线、行军路线等）必须双源验证。"太平洋上空"与"墨西哥湾上空"是不同事实——地理方位错误会削弱全文可信度。

**典型错误**：怀特篇初稿写"太平洋上空160公里"，实际双子座4号主要飞越北美/墨西哥湾/大西洋上空。
...
**规则**：核心意象（如"回程票""断了线的风筝"等）在全文中只能出现一次，通常放在结尾作为"致命一击"。重复使用会削弱首次出现的震撼力。

**典型错误**：戴维森篇v1中"那张回程票，从未被使用过"出现两次（中间+结尾），四AI均指出此问题。
...
**规则**：标题不应直接揭示文章最核心的悬念和最大亮点。如果文章的亮点是"第二条命"的命运反转，标题不应直接点破。

**典型错误**：戴维森篇标题"国王的马踏碎了两条命"直接揭示了琼斯的命运，削弱了读者读到结尾时的冲击力。
...
**规则**：对于历史学界仍有争论的问题，判断性语言应增加推测感（"也许""可能""至今成谜"），避免过于绝对的表述。

**典型错误**：戴维森篇v1写"她不是在求死——她是在求被看见"，历史学界对此仍有争论，如此肯定的表述缺少余地。
...
**规则**：当非核心人物的生平细节（如死因、自杀方式等）在权威史料中难以验证时，应加"据传""据说"等标注，避免将网络流传的内容当作确凿事实。

**典型错误**：戴维森篇v1将琼斯自杀细节写得过于确定，千问指出此情节在英文权威史料中几乎找不到可靠来源。
...
**规则**：当文章涉及激进行为（抗议、暴力、自残等）时，必须在行为描写之前补充制度压迫的背景，让读者理解"为什么这个人会被逼到这一步"。

**典型错误**：戴维森篇v1直接写"她纵火焚烧邮箱、砸碎商店橱窗"，但未交代1832年改革法案将女性排除在选举权之外的历史背景。

**自检**：
- □ 激进行为之前是否有制度压迫的背景铺垫？
- □ 读者能否理解"为什么这个人会被逼到这一步"？

### Rule 42. 四AI一致指出的问题为P0级（元规则）

**规则**：当四个AI（DS/千问/豆包/IMA）一致指出同一问题时，该问题自动升级为P0级，必须修复。三个AI一致指出为P1级。

**自检**：
- □ 四AI交叉诊断后，是否有四个AI一致指出的问题？
- □ 如果有，是否已修复？

### Rule 43. 经济援助/条约类题材必须确认援助范围（🆕v6.1）

**规则**：涉及经济援助、国际条约、军事同盟等题材时，必须双源验证：①援助/条约的地理覆盖范围 ②适用对象 ③附加条件的具体内容。将不属于援助范围的对象错误纳入，属于P0级事实硬伤。

**来源**：马歇尔计划篇四AI一致指出"西德和日本"错误——马歇尔计划仅覆盖欧洲16国，日本重建是独立的美国占领政策体系。

**自检**：
- □ 文中提到的援助/条约覆盖范围是否经过双源验证？
- □ 是否将不属于该体系的对象错误纳入？
- □ 附加条件描述是否具体而非笼统？

### Rule 44. 人物决策的前置动机必须交代（🆕v6.1）

**规则**：当文章主角做出重大决策时，必须交代决策的直接触发因素（出访经历、关键对话、突发事件等）。仅写"他决定做X"而不交代"为什么在这一刻决定"，读者会感到突兀。

**来源**：马歇尔计划篇四AI一致指出缺少"莫斯科归来"转折——马歇尔刚从莫斯科与莫洛托夫谈判三周归来，合作幻想破灭，这是他选择单方面行动的直接触发因素。
...
## 5J. 四AI交叉优化知识库（2026-06-04 🆕）

> **来源**：戴维森篇四AI（DS/千问/豆包/IMA）同题诊断。千问指出P0级事实错误（入狱3次→9次），四AI一致指出回程票重复、结尾说教。

### 四AI长板分工

| AI | 长板 | 典型贡献 |
|----|------|---------|
| DS | 结构分析、标题设计 | 指出标题剧透、判断过于绝对 |
| 千问 | 事实核查、数据验证 | 指出入狱次数错误、琼斯史实存疑 |
| 豆包 | 节奏把控、段落整合 | 指出碎片化、背景不足 |
| IMA | 意象精炼、留白 | 指出回程票重复、说教问题 |
...
### 马歇尔计划篇新增知识（2026-06-05 🆕v6.1）

| AI | 长板 | 典型贡献 |
|----|------|---------|
| DS | 逻辑链条、结尾聚焦 | 指出"世界第三大经济体"模糊、结尾应聚焦铁幕 |
| 千问 | 场景细节、传播策略 | 指出刻意低调策略是"最精妙的部分"、演讲现场感缺失 |
| 豆包 | 情感连接、标题设计 | 指出标题太"教科书"、地缘背景缺失（共产党支持率飙升） |
| IMA | 开篇冲击力、逻辑完整性 | 指出开篇可以更有力、苏联段落需要更多心理博弈 |

**四AI一致指出**：
1. P0：日本不属于马歇尔计划 → 新增Rule 43
2. P1：缺少"莫斯科归来"转折 → 新增Rule 44
3. P1："世界第三大经济体"模糊 → 改为具体描述
4. P1：结尾可更聚焦 → 聚焦铁幕而非抽象"军事基地"

**新增叙事技法**：
- **传播策略是叙事金矿**：刻意低调、BBC传播、真实听众不在现场——这类"幕后操作"比计划本身更有戏剧性
- **"饥饿的人不挑意识形态"**：用一句话交代地缘背景，比空泛描述更有冲击力
- **人物决策前置动机**：重大决策前必须交代触发事件（莫斯科归来→合作幻想破灭→单方面行动）

---

## 5K. 镜像细节技法（2026-06-03 🆕）

> **来源**：怀特太空行走篇四AI（DS/IMA/千问/豆包）同题诊断。IMA版发现"舱门关不上vs打不开"的镜像呼应是全文最强叙事引擎。
...
| 阶段 | 镜像A | 镜像B | 叙事效果 |
|------|-------|-------|----------|
| 怀特篇 | 舱门关不上（太空行走后） | 舱门打不开（阿波罗1号火灾） | 命运的彩排vs正式演出 |
| 海德里希篇 | 卡壳的枪（刺杀时） | 炸弹碎片（车内） | 武器的不可靠vs致命的可靠 |
| 敦煌篇 | 藏经洞被封存（11世纪） | 藏经洞被打开（1900年） | 封存=保护 vs 打开=流失 |

### 搜索阶段的镜像挖掘

**选题确认后、写作前，必须自问**：
- □ 这个事件中，是否有同一类型的物理对象/动作在不同阶段**以相反形式**出现？
- □ 这个"镜像"能否成为文章的核心意象？
- □ 如果找到了镜像，标题是否应该围绕它设计？

**搜索关键词**：在搜索事件详情时，主动搜"XX的第一次""XX之前""XX之后"，寻找镜像素材。
...
当镜像细节足够强大时，标题可以直接围绕它设计：
- "那扇门"（怀特篇）
- "那把卡壳的枪"（海德里希篇）
- "那卷被封存的经书"（敦煌篇）

**原则**：镜像标题 > 泛化标题。"那扇门"比"触摸太空的人"更有叙事聚焦力。

---

## 10. 自动化审校子系统 (2026-05-29 🆕)

> **来源**：借鉴 [awesome_proofreading_auto](https://github.com/qqfly1to19/awesome_proofreading_auto) 的架构模式，构建历史文章专用审校系统。
>
> **核心思路**：将现有的「自检清单」升级为「自动化审校系统」，从「人工打勾」变为「Agent自动检测 + 结构化报告」。
...
**借鉴 awesome_proofreading_auto 的调度机制**：

| 特性 | 说明 |
|------|------|
| **最大并行数** | 3个Agent同时运行 |
| **即时补位** | 一个完成后立即启动下一个 |
| **状态持久化** | `_progress.json` 支持断点续审 |
| **分段处理** | 每段~200字，重叠50字，避免上下文丢失 |

**调度流程**：
1. 主Agent将文章分段
2. 为每个分段生成6个审校任务
3. 维护pending/running/completed队列
4. 始终保持3个Agent并行运行
5. 每20分钟自动保存进度
...
```json
{
  "article_id": "2026-05-29",
  "title": "爱尔兰皇后号沉没",
  "review_timestamp": "2026-05-29T18:00:00+08:00",
  "summary": {
    "total_issues": 12,
    "p0_count": 0,
    "p1_count": 3,
  ...
  "issues": [
    {
      "id": 1,
      "category": "language",
      "subcategory": "rhythm_word",
      "severity": "p2",
      "location": "P15-P18",
      "current": "船撞上了",
      "suggested": "船——撞上了",
      "reason": "关键动作前用破折号制造停顿感（节奏词技法#1）",
      "rule_ref": "5H.1"
    }
  ]
}
...
| 特性 | 说明 |
|------|------|
| **交互式错误高亮** | 文中标记 ↔ 右侧面板双向联动 |
| **智能筛选** | 按严重程度/类别筛选问题 |
| **统计面板** | P0/P1/P2计数 + 各类别统计 |
| **响应式设计** | 支持单栏/双栏布局 |

### 10.5 文件结构

```
C:\Users\admin\.workbuddy\skills\history-today-writer\
├── SKILL.md                    # 主技能文件
├── review/                     # 审校子系统
│   ├── prompts/                # 6项审校维度的Prompt模板
│   │   ├── 01_language.md      # 语言组织校对
│   │   ├── 02_fact_accuracy.md # 史实准确性校对
│   │   ├── 03_narrative_logic.md # 叙事逻辑校对
│   │   ├── 04_terminology.md   # 术语一致性校对
│   │   ├── 05_structure.md     # 结构规范校对
│   │   └── 06_expression.md    # 表达润色校对
│   ├── schema/
│   │   └── review_output.json  # JSON输出格式规范
│   ├── templates/
│   │   └── report.html         # HTML报告模板
│   └── scripts/
│       └── review_scheduler.py # 审校调度脚本
└── archive/                    # 审校历史归档
...
```bash
python review/scripts/review_scheduler.py <article_path> [output_dir]
```
...
| 维度 | 现有系统 | 审校子系统 | 关系 |
|------|----------|------------|------|
| **自检清单** | Rule 1-25 + P0/P1/P2 | 6项审校维度 | 审校子系统自动化执行自检清单 |
| **写作流程** | 选题→写作→自检 | 写作→审校→修改 | 审校子系统在写作完成后触发 |
| **反馈机制** | Feedback Log | JSON/HTML报告 | 审校子系统提供结构化反馈 |
| **质量标准** | P0=0 AND P1≤1 | 相同标准 | 审校子系统自动判定是否通过 |

### 10.9 审校流程整合到自动化（2026-05-29 🆕）

**审校流程已正式整合到「历史上的今天」自动化任务的 Phase 3.5**：

```
完整流程：
Phase 0: 防重跑检查
    ↓
Phase 1: 选题阶段（五维评分 + 淘汰测试）
    ↓
Phase 2: 写作阶段（13条规则 + 6维度叙事）
    ↓
Phase 3: 质量审核 + Humanizer（P0/P1/P2自检 + 去AI味）
    ↓
Phase 3.5: 自动化审校（6维度深度审校 + JSON报告）
    ↓
Phase 3.6: 判例检索（审校发现P0/P1时，搜CASE_STUDIES找同类历史解法）🆕
    ↓
Phase 4: 输出（全文 + 执行摘要 + 审校结果）
    ↓
Phase 5: 记忆更新（MEMORY.md + TOPICS.md + CASE_STUDIES.md）
```

### 10.10 判例检索机制（2026-06-01 🆕）

> **核心原则**：CASE_STUDIES.md 不预加载，按需检索。审校发现具体问题时，用 Grep 搜同类历史问题的解法。

**触发条件**（满足任一即触发）：
- 审校发现 P0 级问题（事实错误、数据矛盾、虚构细节）
- 审校发现 P1 级问题且该问题类型在 CASE_STUDIES 中有先例
- 四AI对比后发现与历史文章类似的问题模式

**检索关键词映射**：

| 审校发现的问题类型 | 搜索关键词 | 预期命中 |
|-------------------|-----------|---------|
| 虚构情节细节 | `虚构\|凭空\|史料依据\|摔碎酒杯` | 2026-06-01 尼泊尔 |
| 阴谋论空洞 | `阴谋论\|疑点\|只抛问题` | 2026-06-01 尼泊尔 |
| 比喻不准确 | `比喻\|修辞\|防弹衣\|事实推敲` | 2026-05-27 海德里希 |
| 排他性措辞 | `第一次\|首次\|唯一\|排他性` | 2026-05-22 朝美条约 |
| 时间跨度错误 | `时间跨度\|世纪\|封闭` | 2026-05-26 敦煌 |
| 结尾缺正面收束 | `结尾给光\|叹息\|正面收束` | 2026-05-26 敦煌 |
| 数据口径矛盾 | `数据口径\|乘客数\|总人数` | 2026-05-29 皇后号 |
| 人物弧光脱节 | `人物弧光\|人物百科\|后半生` | 2026-05-22 朝美条约 |
| 逻辑链条断裂 | `逻辑链\|因果\|跳跃` | 2026-05-25 王尔德 |
| 元评价词 | `元评价\|触目惊心\|令人震惊` | 2026-05-28 瑷珲条约 |
| 节奏词不足 | `节奏词\|小词\|螺丝钉` | 2026-05-28 瑷珲条约 |

**使用方式**：
```
审校发现 P0："摔碎酒杯"无史料依据
    ↓
Grep "虚构\|史料依据" → CASE_STUDIES.md
    ↓
命中 2026-06-01 条目：同类问题的解法是"改用模糊但准确的表述"
    ↓
应用解法 → "醉酒失态，被父亲训斥"
```

**注意**：
- 检索是**辅助决策**，不是机械照搬——每次事件的具体语境不同
- 如果 CASE_STUDIES 中没有命中，说明是新问题类型——修复后应追加到 CASE_STUDIES
- 四AI对比阶段也应检索：对比完成后，检查发现的问题是否在 CASE_STUDIES 中有先例

**审校输出位置**：
- JSON报告：`archive/daily/{YYYY-MM-DD}_review.json`
- 审校结果摘要：包含在执行摘要中

**审校结果格式**：
```
审校结果：✅ 通过 | P0=0 P1=1 P2=9
主要问题：[列出P0/P1问题]
优化建议：[列出2-3个P2建议]
```
...
*Version: v5.8 | 2026-05-29 | 审校流程正式整合到自动化任务Phase 3.5；新增10.9节说明审校流程与自动化的关系；自动化prompt已更新包含审校流程*</think>
