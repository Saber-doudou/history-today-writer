...
- 写完后必须运行 `scripts/sync_check.py` 核验（规则数 184=129+55、版本号、文件路径、hot 规则正文完整性）
...
| 判例库 | `review/CASE_STUDIES.md` | 64条案例（续号至64） |
