...
| 写作规则 | `writing_rules.md` | 叙事结构+6维工具包+64条规则+29条禁止模式 |
| 审校规则 | `review_rules.md` | 审校表+元规则+Rule 31-64+审校子系统 |
...
*Version: v9.3.6 | 2026-06-30 | Rule 64（天文事件"撞击"vs"空中爆炸"）+ Forbidden #29（自然现象局部替代整体）；通古斯大爆炸四AI学习*
